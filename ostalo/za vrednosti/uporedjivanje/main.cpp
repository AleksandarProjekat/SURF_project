...
int main() {
    ...
    std::ifstream file2("talasPSDS.surf");
    ...
    if (count > 0) {
        if (validCount > 0) {
            ...
            std::cout << "Svi brojevi u fajlovima su isti. Nema validnih izračunatih procenata greške." << std::endl;
        }
    } else {
        std::cout << "Fajlovi su prazni. Nema validnih izračunatih procenata greške." << std::endl;
    }
