...
if (!pixels1D_file.is_open()) {
    ...
    // Dodajemo ispis ulaznih vrednosti
    cout << "----------------------------" << endl;
    cout << "Iteracija: " << iteration_counter << endl;
    cout << "Ulazne vrednosti:" << endl;
    cout << "iradius: " << iradius << endl;
    cout << "fracr: " << fracr << endl;
    cout << "fracc: " << fracc << endl;
    cout << "inv_spacing: " << inv_spacing << endl;
    cout << "iy: " << iy << endl;
    cout << "ix: " << ix << endl;
    cout << "step: " << step << endl;
    cout << "_cose: " << _cose << endl;
    cout << "_sine: " << _sine << endl;
